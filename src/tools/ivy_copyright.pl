#!/usr/bin/perl
#################################################################
# ivy_copyright.pl -- update copyright notices throughout the source tree, idempotently.
#
...
my $pgdg      = 'IvorySQL Global Development Team';
my $pgdgk      = 'HighGo Software Co.,Ltd.';
my $cc        = 'Copyright \(c\)';
